...
public class App extends Application {
    ...
    static Label superBar = new Label(superAction + "/100");
    ...
    public void start(Stage stage) throws IOException {
        ...
        Label supportStats = new Label(
                "Support HP = 25, Support Atk = 5. Heals the enemy with the lowest amount of HP percentage based on max HP");
        ...
        // Creating and adding player actions within the app.
            // Attack Action.
                ...
                attackButton.setOnAction(event -> onAttackClick());
            ...
            // Special/Heal Action.
                ...
                specialButton.setOnAction(event -> onSpecialClick());
            ...
            // Parry Action.
                ...
                parryButton.setOnAction(event -> onParryClick());
            ...
            // Super Action.
                ...
                superButton.setOnAction(event -> onSuperClick());
    ...
    static void onSuperClick()
    {
        if (!dead) {
            if (superAction == 100) {
                // Sets super gauge back to 0 and damages all enemies by 50% of their max
                // health.
                superAction = 0;
                tankHealth -= 35;
                attackHealth -= 25;
    ...
    static void enemyActionChoosing() {
        ...
        if (!tankDead) {
            ...
            if (tankTurn == 1 && enemyAction.nextInt(2) == 0 && tankHealth > 0) {
                ...
                // If parry is true, and if player choice is the tank enemy, tank enemy gets
                // parried and will not do any damage.
                if (parry && choice == 1) {
        ...
        if (!supportDead) {
            ...
            if (supportTurn == 1 && enemyAction.nextInt(2) == 0) {
                // If parry is true and player choice is support enemy, support enemy parried
                // and will deal no damage.
                if (parry && choice == 2) {
            ...
            // If number is 1, perform this action.
                ...
                // Checks percentages of enemies based on max health, lowest will be prioritized
                // for healing.
                ...
                } else if (supportHealth < 25 && supportHealth / 25 < attackHealth / 50
                        && supportHealth / 25 < tankHealth / 70) {
                    supportHealth += 10;
                    if (supportHealth > 25) {
                        supportHealth = 25;
                    }
                } else if (attackHealth < 50 && attackHealth / 50 < tankHealth / 70
                        && attackHealth / 50 < supportHealth / 25) {
                    attackHealth += 15;
                    if (attackHealth > 50) {
                        attackHealth = 50;
                    }
        ...
        if (!attackDead) {
            ...
            if (attackTurn == 1 && enemyAction.nextInt(2) == 0 && attackHealth > 0) {
                // Attacks, if parry is true and player choice is attack enemy, attack enemy
                // gets parried and deals no damage.
                if (parry && choice == 3) {
                ...
                // Else, attack the enemy, if attack buff is true, deal double damage, else deal
                // base damage.
                else {
                    if (atkBuff) {
                        attackAttack *= 2;
            ...
            // If number is 1, perform this action.
                ...
                if (parry && choice == 3) {
                    ...
                    // If attack buff already is true, attack instead, else, enable attack buff to
                    // true.
                    if (atkBuff) {
                        attackAttack *= 2;
                        playerHealth -= attackAttack;
    ...
    static void checkWinLosses() throws IOException {
        ...
        // If all enemy health bars are 0, increase wins and save it in text file to be
        ...
        // If player health is 0, increase loses and save it in text file to be
        // displayed in the app.
